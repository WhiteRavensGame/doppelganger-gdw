...
public class tk2dUIItem : MonoBehaviour
{
	...
	//QQQQ what PlayMaker Event to Broadcast when CLICKED
	[SerializeField]
	public string PlayMakerEventThrow;
    ...
    public void Release()
    {
        if (isPressed)
        {
			...
			//QQQQ: Brute force for calling FSM Event to go to next room
			PlayMakerFSM.BroadcastEvent(PlayMakerEventThrow);
        }
